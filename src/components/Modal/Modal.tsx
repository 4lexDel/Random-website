                    ...
                    <div className="flex justify-center p-4 w-full max-w-2xl max-h-full">
                        <div className="bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="flex justify-end items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                                <button onClick={(e) => {onClose(e); onSubmit(e);}} type="button" className="text-text bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">I accept</button>
